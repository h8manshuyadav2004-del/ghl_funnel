...
function Javier() {
    ...
    return (
        <div className="app" style={{ transition: 'opacity 0.15s ease' }}>
            {/* 👇 Paste your CSS here inside a <style> tag */}
            <style>{`
...
.hero-section {
  ...
  background-image: url('https://assets.cdn.filesafe.space/qNJ8OVURKM3CHIW641CJ/media/68e03e1bbb793a2beb67990f.jpeg');
...
.hero-background-overlay {
  ...
  right: 0;
  bottom: 0;
  background: linear-gradient(180deg, rgba(10, 15, 30, 0.85) 0%, rgba(15, 23, 42, 0.9) 100%);
  z-index: 1;
}
